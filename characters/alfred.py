class Alfred:
    def __init__(self):
        ...
        self.deck = [
            ...
            {"name": "Energy In Motion", "bonuses": ["+5"], "keyword": ["Player Card"], "value": 5,
             "image_path": "images/player_card_5.png"},
            {"name": "What Goes Up", "bonuses": ["+6"], "keyword": ["Player Card"], "value": 6,
             "image_path": "images/player_card_6.png"},
            {"name": "Must Come Down", "bonuses": ["D4", "D4", "+1"], "keyword": ["Player Card"], "value": 6,
             "image_path": "images/player_card_d4.png"},
            {"name": "Game Theory", "bonuses": ["D4", "D4", "D4"], "keyword": ["Player Card"], "value": 7.5,
             "image_path": "images/player_card_3xd4.png"},
            {"name": "Physical Physics", "bonuses": ["+9"], "keyword": ["Player Card", "Gold Card"], "value": 9,
