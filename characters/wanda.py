class Wanda:
    def __init__(self):
        ...
        self.deck = [
            ...
            {"name": "Nature's Wrath", "bonuses": ["D4", "D6"], "keyword": ["Player Card"], "image_path": "images/player_card_5.png"},
            {"name": "Arcane Blast", "bonuses": ["D4", "D4"], "keyword": ["Player Card"], "image_path": "images/player_card_6.png"},
            {"name": "Electric Shock Spell", "bonuses": ["D8", "Reroll"], "keyword": ["Player Card"], "image_path": "images/player_card_d4.png"},
            {"name": "Super Fire Blast Spell", "bonuses": ["D6", "D6"], "keyword": ["Player Card"], "image_path": "images/player_card_3xd4.png"},
            {"name": "It Worked!", "bonuses": ["D12"], "keyword": ["Player Card", "Gold Card"], "image_path": "images/player_card_9.png"}
        ]
