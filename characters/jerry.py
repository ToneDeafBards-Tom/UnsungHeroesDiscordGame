class Jerry:
    def __init__(self):
        ...
        self.deck = [
            ...
            {"name": "Aware of Your Environment", "bonuses": ["D6", "Reroll Any"], "keyword": ["Player Card"],
             "value": 3.5, "image_path": "images/player_card_5.png"},
            {"name": "Never Get Caught", "bonuses": ["D4", "Swap"], "keyword": ["Player Card", "Defiant Laugh"],
             "value": 2.5, "image_path": "images/player_card_6.png"},
            {"name": "Hide in Plain Sight", "bonuses": ["D6", "Swap"], "keyword": ["Player Card", "Defiant Laugh"],
             "value": 3.5, "image_path": "images/player_card_d4.png"},
            {"name": "Eyes on the Prize", "bonuses": ["D4", "D8"], "keyword": ["Player Card"], "value": 7,
             "image_path": "images/player_card_3xd4.png"},
            {"name": "Way of the Rogue", "bonuses": ["Reroll All", "D6", "Swap"],
             "keyword": ["Player Card", "Gold Card"], "value": 3.5, "image_path": "images/player_card_9.png"}
        ]
